...
function manageTasks(event) {
  ...
  if (event.target.dataset.function === "complete") {
    completeTask(parentLi);
  }
}

// we need to attach listeners to the submit button and the list. Listen for a click, call the 'newTask' function on submit and call the 'manageTasks' function if either of the icons are clicked in the list of tasks.
const taskButtonElement = document.getElementById("submitTask");
taskButtonElement.addEventListener("click", newTask);

const listButtonElement = document.getElementById("todoList");
